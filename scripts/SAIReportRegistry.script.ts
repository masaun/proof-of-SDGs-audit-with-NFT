...
async function deploySmartContracts() {
    ...
    proofOfAuditNFT = await ProofOfAuditNFT.deploy({ gasLimit: 250000, gasPrice: 10000000000000 })
    ...
    saiReportRegistry = await SAIReportRegistry.deploy(PROOF_OF_AUDIT_NFT, something, { gasLimit: 250000, gasPrice: 100000000000000 })
